        ...
        <div class="main-panel ">
                <div class="content-wrapper ">
                  ...
                  <i class="mdi mdi-home "></i>
                         ...
                         <button style="margin-right:150px; color:darkblue; font-size:15px" type="button " class="btn btn-outline-info btn-sm"data-toggle="modal" data-target="#add">أضافة مقال</button>
                    </div>
                    <?php       
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            if (isset($_POST['add'])) {
                                ...
                                if (empty($formErrors)) {
                                        ...
                                        VALUES(:pname, :pdesc,now(),:puser,1,:pimage)");
                                        $stmt->execute(array(
                                            'pname' 	=> $name,
                                            'pdesc' 	=> $description,
                                            'puser'     => $_SESSION['ID'],
                            ...
                            if (isset($_POST['edit'])) {
                                ...
                                $postid        = filter_var($_POST['postid'], FILTER_SANITIZE_NUMBER_INT);
                                if (empty($formErrors)) {
                                    $stmt = $con->prepare("UPDATE post SET post_name = ?,post_description=?,type=1 WHERE post_id =?");
                                ...
                                <form class="float-right" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        <div class="form-group ">
                                            <h4>اسم المقال</h4>
                                            <input type="text" name="name"  placeholder=" اسم المقال " required class="form-control inputName ">
                                        </div>
                                        <div class="form-group ">
                                            <h4>تفاصيل المقال</h4>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="float-right" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                    <div class="modal-body">
                                            <div class="form-group ">
                                                <h4>اسم المقال</h4>
                                                <input type="text" name="name"  placeholder=" اسم المنشور" class="form-control inputName " required>
                                            </div>
                                            <div class="form-group ">
                                                <h4>تفاصيل المقال</h4>
