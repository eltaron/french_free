                  ...
                  <i class="mdi mdi-home "></i>
                    ...
                    <?php
                            ...
                            if (isset($_POST['add'])) {
                                ...
                                if (empty($formErrors)) {
                                        ...
                                        $stmt = $con->prepare("INSERT INTO 
                                            post(post_name, post_description,post_data,users,type,post_image, cat_id)
                                        VALUES(:pname, :pdesc,now(),:puser,0,:pimage, :cat_id)");
                                        $stmt->execute(array(
                                            'pname' 	=> $name,
                                            'pdesc' 	=> $description,
                                            'puser'     =>$_SESSION['ID'],
                        ...
                        $stmt = $con->prepare("SELECT 
                                                post.*, members.username AS Member, category.category_name as category_name
                                            FROM 
                                                post
                                            INNER JOIN 
                                                members 
                                            ...
                                            inner join category
                                            on category.category_id = post.cat_id
                                            Where type =0
                                            ORDER BY 
                                            post_id DESC");
                        $stmt->execute(array());
